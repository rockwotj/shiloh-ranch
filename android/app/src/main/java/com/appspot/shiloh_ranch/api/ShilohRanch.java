...
public class ShilohRanch extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.20.0 of the shilohranch library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Categories extends ShilohranchRequest<com.appspot.shiloh_ranch.api.model.CategoryCollection> {
  ...
  public class Deletions extends ShilohranchRequest<com.appspot.shiloh_ranch.api.model.DeletionCollection> {
  ...
  public class Events extends ShilohranchRequest<com.appspot.shiloh_ranch.api.model.EventCollection> {
  ...
  public class Posts extends ShilohranchRequest<com.appspot.shiloh_ranch.api.model.PostCollection> {
  ...
  public class Sermons extends ShilohranchRequest<com.appspot.shiloh_ranch.api.model.SermonCollection> {
