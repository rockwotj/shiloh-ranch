 ...
 */
public class DeletionSyncTask extends SyncTask {

    public DeletionSyncTask(Context context, ShilohRanch service, ISyncTaskCallback callback) {
        super(context, service, callback);
    }

    @Override
    public Sync getUpdater() throws IOException {
        return new UpdateDeletions(mContext, mService);
    }
}
