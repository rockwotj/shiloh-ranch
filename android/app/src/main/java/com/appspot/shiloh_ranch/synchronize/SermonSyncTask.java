 ...
 */
public class SermonSyncTask extends SyncTask {

    public SermonSyncTask(Context context, ShilohRanch service,ISyncTaskCallback callback) {
        super(context, service, callback);
    }

    @Override
    public Sync getUpdater() throws IOException {
        return new UpdateSermons(mContext, mService);
    }
}
